...
const ProfileCard = ({ currElem }) => {
  ...
  return (
    <div className="w-80 sm:w-90 md:w-80 p-6 transition-all duration-300 ease-in-out hover:-translate-y-2 bg-white/10 backdrop-blur-lg rounded-2xl shadow-lg border border-white/20 hover:shadow-2xl relative overflow-hidden">
      {/* Gradient Overlay */}
      ...
      <div className="p-5 relative z-10 text-left">
        ...
        <div className="flex justify-center space-x-6 mt-6">
          {facebook && (
            ...
            >
              <FaFacebook className="size-8 sm:size-8 md:size-8" />
            </a>
          )}
          {twitter && (
            <a
            ...
            >
              <FaTwitter className="size-8 sm:size-8 md:size-8" />
            </a>
          )}
          {linkedin && (
            <a
            ...
            >
              <FaLinkedin className="size-8 sm:size-8 md:size-8" />
            </a>
          )}
          {whatsapp && (
            <a
            ...
            >
              <FaWhatsapp className="size-8 sm:size-8 md:size-8" />
            </a>
          )}
        </div>
      </div>
